...
import logging
from V3.incidences.incidence_models.ci5_detailed_incidence_model import CI5DetailedIncidenceModel
from V3.incidences.incidence_models.ci5_summary_incidence_model import CI5SummaryIncidenceModel
